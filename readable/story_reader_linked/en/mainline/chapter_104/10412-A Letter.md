...
- **Trail ① Artificial Somnambulism Guidance** (`element 1041201`)
  - Description: The clerks have come with an new idea. They set up many equipment around the plaza.
  - Unlock: `EpisodeFinish=10412`

  > 【Title card】Artificial Somnambulism Guidance (V2.0.16)

  - — Welcome Panel - 00101PL —<br><br>Welcome to the dream, arcanist.<br><br>... To enter the examination dream [Investigator's Stamina & Athletic Performance] ...<br><br>Touch the tip of your nose with your left forefinger,<br>and press the spot above your heart with your right ring finger and middle finger.<br>Hold the position for 3 seconds. When you feel heat in your throat or the middle part of your spine,<br>press the start button. [0/0]<br><br>... To enter the examination dream [Investigator's Practice of Arcanum Knowledge & Incantations] ...<br><br>Press the tip of your tongue against the roof of your mouth and <br>imagine something that makes your anxious or worried as specifically as possible.<br>When there are goose bumps on your skin,<br>press the start button. [0/0]<br><br>… To enter the training dream [Custom Mental Stability] ...<br><br>Clench your fists 3-5 times,<br>push the green button upwards by 1 notch,<br>and press the start button. [0/0]<br><br>… To enter the status simulation dream [Conventional Insight Tour] …<br><br>Hold the afflatus medium or the relevant books you need,<br>swallow the vanilla mint provided by the device,<br>and press the start button. [0/0]<br><br><br>— New Feature Panel - 00102PL —<br><br>How to use the joint training dream [Tactical Cooperation]:<br><br>1. Make sure the distance between the two joint training devices is less than 25m and they are not separated by any<br>aluminium wares;<br>2. Make sure the two devices have the same mode, enemy number, weather and terrain;<br>3. ...<br>4. ...<br>...<br>6. Choose a reasonable mode according to your conditions.
