...
## 600601 · ECHOES IN THE MOUNTAIN

> **Title Card:** ECHOES IN THE MOUNTAIN

White snow covers the distant peaks, and the warming climate has started to reveal the jagged lines of the stone beneath.

However, the weather is still far from pleasant—in fact, the wet early spring has made the grasslands muddy and treacherous.

> **Title Card:** Meadow, Foothill
...
**Semmelweis**: Stop that, Emil. Don’t forget, we’re still in tatzelwurm territory.

**Semmelweis**: However, if you want to get sprayed in the face with its stench, I won't stop you.

**Semmelweis**: “Our brave Emil, in an outstanding contribution to the study of critter biology, used his head to verify the strength of both the teeth and the stench of the tatzelwurm.”

Semmelweis’ dissuasion apparently does the trick. Emil draws back his head and looks around cautiously.
...
Amused by Emil’s comical expression, the other team members let out a burst of good-natured laughter.

Including Emil, they are a small group of six, with Semmelweis leading from the center.

**Semmelweis**: I'm only joking! We wouldn’t just sit around and watch you get ambushed by a monster.

**Emil**: Thanks for the warning, Captain. I’d hate to end up in a "killed in the line of duty" report at the Belgrade branch.
...
**Emil**: They’re just a bunch of lackeys—they’re not even real Manus Vindictae!
...
**Semmelweis**: So, it’s only natural that the sentiment of “arcanists first” has gained wide acceptance among them.

**Semmelweis**: Now both the Foundation and the Austro-Hungarian Empire are doing their best to screen these refugees.

**Semmelweis**: But with so many of them flocking in, and so fast, it’s impossible to conduct a thorough screening of every person.
...
**Emil**: Those who thrive in the hands of the Manus Vindictae are “noble” and “powerful” pure-bloods. As for the trials ... They have no use for mixed-bloods that can’t use arcane skills.
...
**Semmelweis**: What’s even sadder than being exploited is not even getting a reward after the fact.
...
**Semmelweis**: Yes. Tatzelwurms don’t just appear for no reason. If it's ambushed some travelers, we need to lend a hand.

> **Title Card:** TO BE CONTINUED…

---

## 600602 · Forest, Foothill

> **Title Card:** Forest, Foothill

**Semmelweis**: The smell's getting stronger. It must be nearby. Prepare for battle.

The monster’s tracks stretch all the way to the back of a small hill. The closer they get, the more distinct the stench becomes.

Upon reaching the other side, the path before them opens up.

> **Title Card:** Camp, Foothill
...
**Team Member I**: Ugh ... What is this? It’s disgusting.
...
At that very moment, Semmelweis’ communication device buzzes.
...
Semmelweis’ superior does not dwell much on the issue. She quickly moves on.
...
**Semmelweis**: “Tatzelwurms do not have eyes; they hunt by relying on arcane skill fluctuations to locate their prey on the surface.”

**Semmelweis**: A team almost entirely composed of humans versus a team entirely composed of arcanists—without a doubt, tatzelwurms would be more inclined to attack the latter.
...
**Madam Lindsay.**: Located in the center of the camp, with no cover around it, in full view of everyone—

**Madam Lindsay.**: It’s quite simple. That's the tent where they housed the prisoner.
...
As if echoing Semmelweis’ words, a faint female voice emanates from the communication device.
...
**Semmelweis**: Sorry, your voice is a bit soft. I didn’t catch what you said.
...
One, two, three steps—even if an abyss opened up in front of her, she would not stop.

**Emil**: Captain, we’ve got a problem!
...
**Emil**: A member of the patrol team relayed a message. They’ve spotted a group of critters nearby.

**Semmelweis**: The stench of the tatzelwurm must have attracted them.

**Semmelweis**: That’s unfortunate. Our investigation isn’t over yet. We can't let them destroy the scene.

**Semmelweis**: Gather the team and prepare for battle.

**Emil**: Roger! I’ll notify the others right away.
...
## 600603 · Laplace Rehabilitation Center
